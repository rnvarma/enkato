...
export default class Quiz extends Component {
    ...
    render() {
        return (
            <div className="quiz">
                currentQuestion (Q{this.state.currentQuestion + 1}: {this.props.questions[this.state.currentQuestion].quizQuestionText} - currentAnswer (C{this.state.currentAnswer + 1}): {this.props.questions[this.state.currentQuestion].choiceList[this.state.currentAnswer].text}
            </div>
        );
    }
}
